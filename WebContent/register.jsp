...
<script language="javascript"> 
	...
	function verflag(){
		...
		var psw1=document.getElementById("txt_passwd");
		var psw2=document.getElementById("txt_repasswd");
...
<div id=logo></div>
<div id=top>
<table width="442" border="0" align="left" cellpadding="0" cellspacing="0" style="font-size:18px; color:red; font-weight:bold">
  <tr align="center">
    <td height="250" colspan="2"><font size="50px">欢迎使用3+2网上购物系统！</font></td>
  </tr>
  <tr>
    <td width="414" height="250"><table width="75%" border="0" align="center" cellpadding="5" cellspacing="0">
        <form name="form1" action="AddUser" method="post" onsubmit="return verflag()">
          <tr>
          ...
          <tr>
            <td height="22" align="right" class="font_white">重 复  密  码:</td>
            <td height="22"><input name="repeatpassword" type="password" class="textbox" id="txt_repasswd" size="19" maxlength="50"></td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="22" colspan="2" align="center"><input name="login" type="submit" id="login" value="注 册" class="button">
&nbsp; &nbsp;&nbsp;&nbsp;
